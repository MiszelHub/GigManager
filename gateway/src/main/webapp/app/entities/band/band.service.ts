...
export class BandService {
    ...
    private resourceUrl =  SERVER_API_URL + '/bandservice/api/bands';
    ...
    private convertItemFromServer(json: any): Band {
        ...
        entity.dateOfFormation = this.dateUtils
            .convertLocalDateFromServer(json.dateOfFormation);
        return entity;
    }
    ...
    private convert(band: Band): Band {
        ...
        copy.dateOfFormation = this.dateUtils
            .convertLocalDateToServer(band.dateOfFormation);
        return copy;
    }
}
